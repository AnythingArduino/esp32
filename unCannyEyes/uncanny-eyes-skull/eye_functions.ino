...
void frame(uint16_t iScale) // Iris scale (0-1023)
{
  ...
  eyeX = (eyeX*0.37); //// by Mike to make joystick work
  eyeY = (eyeY*0.3); //// by Mike to make joystick work

 //// Serial.println(eyeX);  //from -1024/0 to 6950/3970
 //// Serial.println(eyeY);  //from -1024 to 6950
